...
Update your LPP with Components, plug MIDI IO into each other (Out1 for the LPP).
...
```
NNNN PPPP
NNNN PPPP  N: notes in the current phrase
NNNN PPPP  P: phrases in the current chain
NNNN PPPP  K: keyboard, scrollable with Up and Down
